...
var category_1 = require("../domain/dto/category");
...
var createCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                result = category_1.CategoryDTO.safeParse(req.body);
                if (!result.success) {
                    throw new validation_error_1.default("Invalid category data");
                }
                return [4 /*yield*/, Category_1.default.create(result.data)];
            case 1:
                _a.sent();
                res.status(201).send();
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Category_1.default.findByIdAndUpdate(id, req.body)];
            case 1:
                category = _a.sent();
                if (!category) {
                    throw new not_found_error_1.default("Product not found");
